...
cprint(figlet_format('TrustIndex', font='larry3d'),
       'yellow', 'on_red')
...
f.close()
#print(pdflist)
#pdf.cell(0, 10, txt= MultiCell(pdflist), ln=1, align="C")
#pdf.output("output/" + timeprint + ".pdf")

exit = input("You will find the chosen articles under:\n>>> output/" + str(timeprint) + ".txt <<<\nPlease enter exit to exit: \n")
